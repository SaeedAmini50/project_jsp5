                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                               ...
                               <a href="showAllAdmin.jsp" class="dropdown-item">show all admin </a>
                                  <a href="create_admin.jsp" class="dropdown-item">create admin</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                              <a href="showAllUser.jsp" class="dropdown-item">show all users</a>
                               <a href="user_order.jsp" class="dropdown-item">show all order users</a>
                               <a href="user_order_week.jsp" class="dropdown-item">show order users one week</a>
                               <a href="user_order_month.jsp" class="dropdown-item">show order users one month</a>
                             </div>
                     ...
                     <div class="nav-item dropdown">
                        ...
                        <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="far fa-file-alt me-2"></i>chart</a>
                        <div class="dropdown-menu bg-transparent border-0">
                              <a href="chart_admin.jsp" class="dropdown-item">chart </a>
                             </div>
